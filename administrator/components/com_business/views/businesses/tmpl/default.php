...
?>
<form action="index.php?option=com_business&view=businesses" method="post" id="adminForm" name="adminForm">
<div class="row-fluid">		
<!--    <div class="span6">			
...
<table class="table table-striped table-hover">
    <thead>
        <tr>
                ...
                <th width="30%">
                        <?php echo JHtml::_('grid.sort', 'COM_BUSINESS_BUSINESSES_ADDRESS', 'address', $listDirn, $listOrder); ?>	
                </th>
                <th width="30%">
    ...
    <tbody>
            <?php if (!empty($this->items)) : ?>
                    <?php foreach ($this->items as $i => $row) :
                            $link = JRoute::_('index.php?option=com_business&task=business.edit&id=' . $row->id);				?>
                            <tr>
                                    ...
                                    <td>
                                            <a href="<?php echo $link; ?>" title="<?php echo $row->address;?>">								
