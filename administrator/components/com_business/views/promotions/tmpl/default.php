...
<table class="table table-striped table-hover">
    <thead>
        <tr>
                ...
                <th width="20%">
                        <?php echo JHtml::_('grid.sort', 'COM_BUSINESS_BUSINESSES_ADDRESS', 'title', $listDirn, $listOrder); ?>	
                </th>
                <th width="10%">
                        <?php echo JHtml::_('grid.sort', 'COM_BUSINESS_BUSINESSES_PROMOTION_TYPE', 'type', $listDirn, $listOrder); ?>	
                </th>
                <th width="10%">
