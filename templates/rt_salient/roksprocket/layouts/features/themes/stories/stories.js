	...
	var Stories = new Class({
		...
		animate: function(container, from, to){
			...
			Object.each(current, function(value, key){
				...
				current[key].removeClass('active').addClass('inactive').styles(Object.merge({}, transition.to, {'z-index': 1}));
				...
				next[key].addClass('active').removeClass('inactive').styles(Object.merge({}, transition.from, initialStyles));
