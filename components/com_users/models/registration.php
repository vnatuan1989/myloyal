...
//                        . "'$datetime' , '$datetime' , '{$business_data['latitude']}' , '{$business_data['address']}' , '{$business_data['longitude']}','{$business_data['type']}') ";
                $querybusiness = "insert into #__business (userId,businessName,phone,cvrNumber,createdAt,updatedAt,latitude,address,longitude,city,country,icon,noter) "
                        . " values ($user->id , '{$business_data['businessName']}' , '{$business_data['phone']}', '{$business_data['cvrNumber']}' , "
                        . "'$datetime' , '$datetime' , '{$business_data['latitude']}' , '{$business_data['address']}' , '{$business_data['longitude']}' , '{$business_data['city']}' , '{$business_data['country']}','coffee.png', '{$business_data['noter']}') ";
                $db = JFactory::getDbo();
