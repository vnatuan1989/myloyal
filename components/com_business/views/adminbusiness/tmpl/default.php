                    ...
                    <div class="container">
                        <div class="business-setting mt50">
                            <h2 class="text-center">Edit your business details</h2>
                                <form class="frm-business-setting" id="contact-form" action="<?php echo JRoute::_('index.php?option=com_business&task=adminbusiness.save'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="task" value="adminbusiness.save" />
                                        </div>
                                    </div>
                                </form>
                        </div>
