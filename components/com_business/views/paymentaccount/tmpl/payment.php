...
<form action="https://ssl.ditonlinebetalingssystem.dk/integration/ewindow/Default.aspx" method="post" id="paymetForm">
    ...
    <input type="hidden" name="accepturl" value="<?php echo JURI::base();?>index.php?option=com_business&view=paymentaccount&layout=select&package=<?php echo $package;?>&userid=<?php echo $userid;?>">
    <input type="hidden" name="cancelurl" value="<?php echo JURI::base();?>index.php?option=com_business&view=paymentaccount&layout=fail">
