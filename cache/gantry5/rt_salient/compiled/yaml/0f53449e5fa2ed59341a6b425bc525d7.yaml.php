...
return [
    ...
    'filename' => 'C:/wamp/www/myloyal/templates/rt_salient/config/menu/mainmenu.yaml',
    'modified' => 1444383658,
    'data' => [
        'ordering' => [
            'home' => '',
        ...
        'items' => [
            ...
            'styles/__particle-muOvm' => [
                ...
                'options' => [
                    'particle' => [
                        'enabled' => '1',
                        'html' => '<div class="g-grid g-preset-thumbnails">
    <div class="g-block">
        <div class="g-content">
