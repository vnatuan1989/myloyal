    ...
    'data' => [
        'items' => [
            ...
            'styles.extension.background-image' => [
                'type' => 'input.imagepicker',
                'label' => 'Background Image',
                'default' => 'gantry-media://rocketlauncher/home/extension/img-01.jpg',
            ...
            'particles.animatedblock' => [
                'type' => '_parent',
                'name' => 'particles.animatedblock'
            ],
            'particles.animatedblock.enabled' => [
                'type' => 'input.checkbox',
                'label' => 'Enabled',
                'description' => 'Globally enable icon menu particles.',
                'default' => true,
                'name' => 'particles.animatedblock.enabled'
            ],
            'particles.animatedblock.class' => [
                'type' => 'input.selectize',
                'label' => 'CSS Classes',
                'description' => 'CSS class name for the particle.',
                'name' => 'particles.animatedblock.class'
            ],
            'particles.animatedblock.bgclass' => [
                'type' => 'select.select',
                ...
                'name' => 'particles.animatedblock.bgclass'
            ],
            'particles.animatedblock.animationclass' => [
                'type' => 'select.select',
                'label' => 'Animation',
                ...
                'name' => 'particles.animatedblock.animationclass'
            ],
            'particles.animatedblock.title' => [
                'type' => 'input.text',
                'label' => 'Title',
                'description' => 'Customize the title text.',
                'placeholder' => 'Enter title',
                'name' => 'particles.animatedblock.title'
            ],
            'particles.animatedblock.image' => [
                'type' => 'input.imagepicker',
                'label' => 'Image',
                'description' => 'Select desired image.',
                'name' => 'particles.animatedblock.image'
            ],
            'particles.animatedblock.headline' => [
                'type' => 'input.text',
                'label' => 'Headline',
                'description' => 'Customize the headline.',
                'placeholder' => 'Enter headline',
                'name' => 'particles.animatedblock.headline'
            ],
            'particles.animatedblock.desc' => [
                'type' => 'textarea.textarea',
                'label' => 'Description',
                'description' => 'Customize the description.',
                'placeholder' => 'Enter short description',
                'name' => 'particles.animatedblock.desc'
            ],
            'particles.animatedblock.readmore' => [
                'type' => 'input.text',
                'label' => 'Read More',
                'description' => 'Specify the readmore text.',
                'name' => 'particles.animatedblock.readmore'
            ],
            'particles.animatedblock.link' => [
                'type' => 'input.text',
                'label' => 'Link',
                'description' => 'Specify the readmore link address.',
                'name' => 'particles.animatedblock.link'
            ],
            'particles.animatedblock.button' => [
                'type' => 'input.text',
                'label' => 'Button',
                'description' => 'Specify the button text.',
                'name' => 'particles.animatedblock.button'
            ],
            'particles.animatedblock.buttonclass' => [
                'type' => 'input.selectize',
                'label' => 'Button Classes',
                'description' => 'CSS class name for the button.',
                'name' => 'particles.animatedblock.buttonclass'
            ],
            'particles.blockcontent' => [
                'type' => '_parent',
            ...
            'particles.blockcontent.subcontents.*.link' => [
                'type' => 'input.text',
                'label' => 'Item Link',
                'description' => 'Specify the link address for the item.',
                'name' => 'particles.blockcontent.subcontents.*.link'
            ],
        ...
        'nested' => [
            'styles' => [
                'above' => [
                    ...
                    'background-image' => 'styles.above.background-image'
                ],
                'accent' => [
            ...
            'particles' => [
                ...
                'animatedblock' => [
                    ...
                    'class' => 'particles.animatedblock.class',
                    'bgclass' => 'particles.animatedblock.bgclass',
                    'animationclass' => 'particles.animatedblock.animationclass',
                    'title' => 'particles.animatedblock.title',
                    'image' => 'particles.animatedblock.image',
                    'headline' => 'particles.animatedblock.headline',
                    'desc' => 'particles.animatedblock.desc',
                    'readmore' => 'particles.animatedblock.readmore',
                    'link' => 'particles.animatedblock.link',
                    'button' => 'particles.animatedblock.button',
                    'buttonclass' => 'particles.animatedblock.buttonclass'
                ],
                'blockcontent' => [
                    ...
                    'subcontents' => [
                        '*' => [
                            ...
                            'link' => 'particles.blockcontent.subcontents.*.link',
